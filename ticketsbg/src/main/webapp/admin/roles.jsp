        ...
        <f:view>
            <h:form id="roleForm">
                ...
                <a4j:commandLink value="#{msg.add}" ajaxSingle="true"
                    action="#{roleController.newRecord}"
                    oncomplete="#{rich:component('entityPanel')}.show()" />
                <a4j:region>
                    <rich:dataTable
                        onRowMouseOver="this.style.backgroundColor='#F1F1F1'"
                        onRowMouseOut="this.style.backgroundColor='white'" cellpadding="0"
                        cellspacing="0" width="700" border="0" var="role"
                        value="#{roleController.rolesModel}" id="rolesTable">
                        ...
                        <rich:column>
                            <a4j:commandLink title="#{msg.edit}" ajaxSingle="true"
                                ...
                                <f:setPropertyActionListener value="${role}"
                                    target="#{roleController.role}" />
                            </a4j:commandLink>
                            <h:outputText value="&#160;" />
                            <h:commandLink action="#{roleController.delete}"
                                title="#{msg.remove}">
