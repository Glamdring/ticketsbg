                    ...
                    <rich:panel headerClass="rich-panel-header-main"
                        ...
                        <rich:graphValidator>
                            <h:panelGrid columns="3">
                                ...
                                <h:inputText value="#{loggedUserHolder.loggedUser.email}"
                                    id="email" size="35">
                                ...
                                <h:selectOneMenu
                                    value="#{loggedUserHolder.loggedUser.customerType}"
                                ...
                                <h:inputText value="#{loggedUserHolder.loggedUser.name}"
                                    id="names" size="35">
                                    <rich:ajaxValidator event="onblur" />
                                </h:inputText>
                                ...
                                <h:inputText value="#{loggedUserHolder.loggedUser.city}"
                                    id="city" size="35" />
